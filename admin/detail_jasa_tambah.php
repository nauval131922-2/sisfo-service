        ...
        <div class="container-fluid">
            ...
            <div class="card ">
                ...
                <div class="card-body" style="width:90%;margin:0 auto;"><br>
                    <!-- Form servis -->
                    <h2 align="Center" class="m-0 text-dark">Jasa Yang Di Beli </h2><br>
                    ...
                    <div class="card ">
                        ...
                        <div class="card " style="border:none;">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h3 class="card-title">Input Jasa</h3>
                            </div>

                            <div class="card-body">
                                <form method="POST" action="detail_jasa_act.php">
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label">Pilih Jasa </label>
                                        <div class="col-sm-5">
                                            <select class="form-control" id="jasa" name="jasa">
                                                <option selected>- Pilih Jenis Jasa -</option>
                                                <?php
                                                include "../database.php";
                                                $tampil = mysqli_query($mysqli, "SELECT * FROM jasa ");
                                                while ($d = mysqli_fetch_array($tampil)) {
                                                    echo "<option value='$d[id_jasa]' data-nama='$d[nama_jasa]' data-harga='$d[harga_jasa]'> $d[nama_jasa] - $d[harga_jasa]</option>";
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-5">
                                            <button type="submit" class="btn btn-outline-success"> Pilih Jasa </button>
                                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table" id="tabel_jasa">
                                ...
                                <tbody align="center">
                                    <?php include "../database.php";
                                    $no = 0;
                                    $data = mysqli_query($mysqli, "select * from transaksi_jasa where id_reparasi='$_GET[id_reparasi]' ");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button class='btn btn-warning btn-sm' onclick="showModalHapus('<?php echo $d['id_jasa']; ?>', '<?php echo $d['id_reparasi']; ?>')">Hapus</button>
                                            </td>
                            ...
                            <?php
                            include "../database.php";
                            $jumlahkan = mysqli_query($mysqli, " SELECT SUM(sub_total) as total from transaksi_jasa where id_reparasi='$_GET[id_reparasi]'");
...
<script>
    ...
    function showModalHapus(jasaIdParam, reparasiIdParam) {
        jasaId = jasaIdParam;
    ...
    document.getElementById('hapusButton').addEventListener('click', function() {
        window.location.href = 'detail_jasa_hapus.php?id_jasa=' + jasaId + '&id_reparasi=' + reparasiId;
    });
</script>
