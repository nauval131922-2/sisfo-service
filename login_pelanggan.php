        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div align=center><a href="index.php"><img src="assets/img/logoskm.png" width=250px></a></div>
              <br>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Masukkan username & password kamu</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" action="periksa_login_pelanggan.php" method="POST">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <div class="invalid-feedback">Masukkan email akunmu!</div>
                      </div>
                    </div>
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Masukkan password akunmu!</div>
                    </div>
